...
make_mat2 <- function(tk0, Y0, id0, z0) {
    .Call('_dynTree_make_mat2', PACKAGE = 'dynTree', tk0, Y0, id0, z0)
}

make_mat2_t <- function(tk0, Y0, id0, z0) {
    .Call('_dynTree_make_mat2_t', PACKAGE = 'dynTree', tk0, Y0, id0, z0)
}

#' @noRd
dynforest_C <- function(mat1f0, mat1Z0, mat2Zf0, r0, zt0, zy0, e0, spCriterion, numTree, minNode1, minSplit1, maxNode, mtry, gp) {
    .Call('_dynTree_dynforest_C', PACKAGE = 'dynTree', mat1f0, mat1Z0, mat2Zf0, r0, zt0, zy0, e0, spCriterion, numTree, minNode1, minSplit1, maxNode, mtry, gp)
}
...
#' 
#' @noRd
dyntree_C <- function(mat1f0, mat1Z0, mat2Zf0, r0, zt0, zy0, e0, spCriterion, numFold, minNode1, minSplit1, maxNode) {
    .Call('_dynTree_dyntree_C', PACKAGE = 'dynTree', mat1f0, mat1Z0, mat2Zf0, r0, zt0, zy0, e0, spCriterion, numFold, minNode1, minSplit1, maxNode)
}
