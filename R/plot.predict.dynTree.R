#' Plotting the predicted survival function from an dynTree object
#'
#' Plot the predicted survival function from dynTree objects.
#'
#' @importFrom ggplot2 ggplot geom_step aes xlab ylab geom_smooth
#'
#' @noRd
#' @export
plot.predict.dynTree <- function(x, ...) {
