...
#' @noRd
dynforest_C <- function(X0, D0, r0, numTree, minNode1, minSplit1, maxNode, mtry) {
...
#' 
#' @noRd
dyntree_C <- function(X0, D0, r0, numFold, minNode1, minSplit1, maxNode) {
    .Call('_dynTree_dyntree_C', PACKAGE = 'dynTree', X0, D0, r0, numFold, minNode1, minSplit1, maxNode)
}
