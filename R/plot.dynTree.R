globalVariables(c("nd", "hazard", "Survival")) ## global variables for plot.dynTree

#' Plotting an \code{dynTree} object
#'
#' Plots an \code{dynTree} object. The function returns a \code{dgr_graph} object that is rendered in the RStudio Viewer or survival/hazard estimate at terminal nodes.
#'   
#' @param x an object of class "\code{dynTree}", usually returned by the dynTree function.
...
#'
#' @seealso See \code{\link{dynTree}} for creating \code{dynTree} objects.
...
#' 
#' @export
#' @example inst/examples/ex_plot_dynTree.R
plot.dynTree <- function(x, output = c("graph", "visNetwork"),
                         digits = 4, tree = 1L,
